...
// Load kamar secara dinamis dari Firestore & hitung kuota booking maksimal (3 booking dikonfirmasi)
...
(function () {
  ...
  // Muat data kamar & data booking dikonfirmasi secara real-time dari Firestore
  try {
    loading.style.display = 'block';

    // 1. Listen ke data kamar
    ...
    onSnapshot(qRooms, (snapRooms) => {
      ...
      console.error('Gagal memuat kamar dari Firestore:', err);
      loading.style.display = 'none';
    });

    // 2. Listen ke data booking berstatus "confirmed"
    ...
    onSnapshot(qBookings, (snapBookings) => {
      ...
      console.warn('Gagal memuat status booking:', err);
    });
